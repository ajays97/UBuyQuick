            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    for (DocumentSnapshot document : documents){
                        ...
                        shops.add(new Shop(shop.get("status").toString(), "560091", "BHYRAVA_PROVISIONS", "BHYRAVA PROVISIONS", shop.get("timings").toString(), shop.get("image_url").toString(), "Siddik Stores, Milk Dairy Bus Stop, Hegganahalli Main Road, Peenya 2nd Stage, Bangalore - 560091"));
